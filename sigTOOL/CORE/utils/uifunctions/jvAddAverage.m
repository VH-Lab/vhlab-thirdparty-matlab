function h=jvAddAverage(h)
% jvAddAverage addpanel function
% 
% Example:
% h=jvAddAverage(h)
%
...
h=jvElement(h{end},'Component', 'javax.swing.JComboBox',...
    ...
    'DisplayList', {'None' '10' '20' '50'},...
    'ReturnValues', {0 10 20 50},...
    'Label', 'Overlap (%)',...
    'ToolTipText', 'Data Overlap between averages');
...
h=jvElement(h{end},'Component', 'javax.swing.JCheckBox',...
    'Position',[0.03 Top-(7.75*Height) 0.48 Height],...
    'Label', 'Subtract DC',...
    'ToolTipText', 'Remove pre-trigger DC level from result');

h=jvElement(h{end},'Component', 'javax.swing.JCheckBox',...
    'Position',[0.03 Top-(8.5*Height) 0.48 Height],...
    'Label', 'Pairwise',...
    'ToolTipText', 'Remove pre-trigger DC level from result');
h{end}.Pairwise.setSelected(false);
