function scFeature(fhandle)
% scRegister utility to email comments/feature requests to sigTOOL
% 
% Example:
% scFeature(fhandle)
%
...
% Panel
p=jvPanel('Title', 'sigTOOL Comment/Feature Request', 'Position', [0.1 0.1 0.8 0.8]);


% Addresses/subject
p=StandardEmailDetails(p, 'sigTOOL:Feature');
...
p=jvElement(p, 'Component', 'javax.swing.JScrollPane', 'Label', 'Message (Type or paste your message here)',...
    'Position', [0.1 0.12 0.8 0.23], 'DisplayList','');
