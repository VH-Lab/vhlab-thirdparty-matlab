function [methodinfo,structs,enuminfo]=cfs
%CFS Create structures to define interfaces found in 'cfs'.

%This function was generated by loadlibrary.m parser version 1.1.6.20.4.1 on Sat Mar 31 21:03:47 2007
%perl options:'cfs.i -outfile=cfs.m machine.h'
%
% Edited by hand ML 03/07
...
%fcns.name{fcnNum}='SetDSChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'int16', 'int16', 'uint16', 'int32', 'int32', 'single', 'single', 'single', 'single'};fcnNum=fcnNum+1;
% short WINAPI WriteData ( short handle , WORD dataSection , long startOffset , WORD bytes , TpVoid dataADS ); 
%fcns.name{fcnNum}='WriteData'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'uint16', 'int32', 'uint16', 'voidPtr'};fcnNum=fcnNum+1;
...
%fcns.name{fcnNum}='SetWriteData'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'int16', 'int32', 'int32'};fcnNum=fcnNum+1;
% long WINAPI CFSFileSize ( short handle ); 
%fcns.name{fcnNum}='CFSFileSize'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int16'};fcnNum=fcnNum+1;
...
%fcns.name{fcnNum}='AppendDS'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'int32', 'uint16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='GetDSChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'int16', 'int16', 'uint16', 'int32Ptr', 'int32Ptr', 'singlePtr', 'singlePtr', 'singlePtr', 'singlePtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='GetChanData'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint16'; fcns.RHS{fcnNum}={'int16', 'int16', 'uint16', 'int32', 'uint16', 'voidPtr', 'int32'};fcnNum=fcnNum+1;
% long WINAPI GetDSSize ( short handle , WORD dataSection ); 
fcns.name{fcnNum}='GetDSSize'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int16', 'uint16'};fcnNum=fcnNum+1;
% short WINAPI ReadData ( short handle , WORD dataSection , long startOffest , WORD bytes , TpVoid dataADS ); 
%fcns.name{fcnNum}='ReadData'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'uint16', 'int32', 'uint16', 'voidPtr'};fcnNum=fcnNum+1;
