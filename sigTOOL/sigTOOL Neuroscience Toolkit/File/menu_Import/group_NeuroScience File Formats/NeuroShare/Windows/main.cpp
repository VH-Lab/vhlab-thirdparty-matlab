...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxInfo is filled.
ns_RESULT fEntityInfo(UINT32 hFile, UINT32 ncols, double *pdEntityID, mxArray **ppmxInfo)
{
...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxInfo is filled.
ns_RESULT fEventInfo(UINT32 hFile, UINT32 ncols, double *pdEntityID, mxArray **ppmxInfo)
{
...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxInfo is filled.
ns_RESULT fAnalogInfo(UINT32 hFile, UINT32 ncols, double *pdEntityID, mxArray **ppmxInfo)
{
...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxInfo is filled.
ns_RESULT fSegmentInfo(UINT32 hFile, UINT32 ncols, double *pdEntityID, mxArray **ppmxInfo)
{
...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxInfo is filled.
ns_RESULT fSegmentSourceInfo(UINT32 hFile, UINT32 ncolsEntity, double *pdEntityID, 
                             UINT32 ncolsSource, double *pdSourceID, mxArray **ppmxInfo)
{
...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxInfo is filled.
ns_RESULT fNeuralInfo(UINT32 hFile, UINT32 ncols, double *pdEntityID, mxArray **ppmxInfo)
{
...
ns_RESULT fEventData(UINT32 hFile, UINT32 ncolsEntity, double *pdEntityID, UINT32 ncolsIndex, 
...
//          ppmxData is filled.
ns_RESULT fAnalogData(UINT32 hFile, UINT32 ncols, double *pdEntityID, UINT32 dwIndex, 
                      UINT32 dwIndexCount, mxArray **ppmxContCount, mxArray **ppmxData)
{
    ...
    pdData = (double *)calloc(dwIndexCount, 8);//ML 08.01.10
...
ns_RESULT fSegmentData(UINT32 hFile, UINT32 ncolsEntity, double *pdEntityID, UINT32 ncolsIndex, 
                       double *pdIndex, mxArray **ppmxTimeStamp, mxArray **ppmxData, 
                       mxArray **ppmxSampleCount, mxArray **ppmxUnitID)
{
    ...
    if (0 < dwMaxSampleCount)
    {
        ...
        pdData = (double *)calloc(dwMaxSampleCount, 8);
    ...
    for (i = 0; i < ncolsEntity; ++i)
    {
        for (j = 0; j < ncolsIndex; ++j)
        {
            nsresult = ns_GetSegmentData(g_nsDllHandle, hFile, (UINT32) pdEntityID[i], (UINT32) pdIndex[j], 
                                         &dTimeStamp, pdData, 8 * dwMaxSampleCount, &dwSampleCount, 
                                         &dwUnitID);
            if (0 == nsresult)
            {
...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxData is filled.
ns_RESULT fNeuralData(UINT32 hFile, UINT32 ncols, double *pdEntityID, UINT32 dwIndex, 
                      UINT32 dwIndexCount, mxArray **ppmxData)
{
    ...
    pdData = (double *)calloc(dwIndexCount, 8);
...
// Outputs: ns_RESULT - what error was returned by the function (should be 0)
//          ppmxIndex is filled.
ns_RESULT fIndexByTime(UINT32 hFile, UINT32 ncols, double *pdEntityID, double dTime, INT32 nFlag, 
                       mxArray **ppmxIndex)
{
    UINT32 i;
    UINT32 dwIndex;
    ...
    case 1:     // function ns_OpenFile
        {
            ...
            // Get the length of the input string and allocate memory for it.
            {
                ...
                szFile = (char *)mxCalloc(cbBuffer, sizeof(char));
    ...
    case 16:    // function ns_GetTimeByIndex
        {
...

            {
                ...
                fresult = fTimeByIndex(hFile, dwEntityID, dwIndexCount, pdIndex, &plhs[1]);
