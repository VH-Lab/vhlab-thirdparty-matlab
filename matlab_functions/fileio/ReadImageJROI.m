...
%           is preserved
%
% Copyright (c) 2011-2106 Dylan Muir <dylan.muir@unibas.ch>
% 
%  From Matlab File Exchange. If we use it, we need to cite:
%      "Muir and Kampa, "FocusStack and StimServer: A new open source
%       MATLAB toolchain for visual stimulation and analysis of two-photon
%       calcium neuronal imaging data". Frontiers in Neuroinformatics
%       2015."
%
%
%
